...
class HeaderMenu:
    def __init__(self, driver):
        ...
        self.login_locator = Login.login_button

    def search_page(self, time=5):
        self.driver.find_element(By.XPATH, self.search_locator).click()
        return WebDriverWait(self.driver, time).until(
            expected_conditions.presence_of_element_located((By.XPATH, self.LogOut_locator)),
    ...
    def LogOut(self, time=10):
        ...
        return WebDriverWait(self.driver, time).until(
            expected_conditions.presence_of_element_located((By.CSS_SELECTOR, self.login_locator)),
